...
// Filtering arrays
    ...
    /* function showing how filtering works */
...
// Transforming with map
    ...
    /* function showing how map computes */
...
console.log([1,2,3,4].reduce((a, b) => a + b)); //NOTE THAT THE START ARGUMENT IS LEFT IN THIS CASE AND IS TAKEN AS 0

    /* using reduce twice example */
...
// Composability
    /*writing the above formula without higher order functions*/
...
console.log(biggest);//
    ...
    /* an example of composing code and how higher orders functions shows its advantages*/
...
console.log(Math.round(average(
    ...
    /* above code can we written as a big loop however it will be harder to see what is going on */
...
console.log(Math.round(total /count)); //result although accurate gaves only a number as a result and that could be misleading.
// String and Character Codes

    /* this function presents the "some" method */
    /* it is important here to understand how code units per character works in JS(consider also methods such as  codePointAt, charCodeAt) */
...
console.log(countBy([1,2,3,4,5], n => n > 2 ));
    /* function that tells which scipts are used in a piece of text */
    ...
    console.log(textScripts('小島"woof",フラワーズ"λουλούδια"'));